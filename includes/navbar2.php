...
<style>
    ...
    .user-email-frame {
        ...
        padding: 6px 12px;
        border: 2px solid #fff; /* Viền trắng nổi bật trên nền đen */
        border-radius: 20px; /* Bo góc mềm mại */
        background-color: #1a1a1a; /* Nền xám đậm để tương phản nhẹ */
        color: #fff; /* Chữ trắng */
        font-weight: 600;
    ...
    .user-email-frame:hover {
        background-color: #333; /* Nền sáng hơn khi hover */
        border-color: #ccc; /* Viền nhạt hơn khi hover */
